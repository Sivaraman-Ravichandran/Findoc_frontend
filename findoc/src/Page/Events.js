...
const Events = () => {
    ...
    const dummyNews = [
      {
        ...
        date: '2024-07-20',
        content: 'A new health initiative has been launched to improve community health.',
      },
      {
        title: 'COVID-19 Vaccination Drive',
        date: '2024-07-25',
        content: 'A mass COVID-19 vaccination drive will take place this weekend.',
      },
  ...
  const ongoingEvents = events.filter(event => new Date(event.date) <= new Date());
